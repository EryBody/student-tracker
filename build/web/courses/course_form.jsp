                                                        ...
                                                        <%
                                                            ...
                                                            if (instructorMap.isEmpty()) {
                                                                ...
                                                                while (itr.hasNext()) {
                                                                    ...
                                                                    // Check if the current record matches the selected value
                                                                    boolean isSelected = id.equals(instructorId);
                                                                    ...
                                                                    // Add the same option without "selected" attribute for other records
                                                                    if (!isSelected) {
