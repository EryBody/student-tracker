...
public class CourseTest {
    ...
    public void testAddCourseData() {
        ...
        bean.setCourseName("");
        bean.setUnit(10);
        bean.setEntryDate(new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
    ...
    public void testUpdateCourseData(String studentId) {

        bean.setCourseId(studentId);
        bean.setInstructorId("");
        bean.setCourseName("");
        bean.setUnit(10);
    ...
    public void testGetCourseData(String courseId) {
        ...
        if (sb != null) {
            ...
            System.out.println("Entry Date: " + sb.getEntryDate());
        } else {
